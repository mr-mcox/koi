...
from screen.baml_client.baml_client.types import StopAction as BAMLStopAction
...
def test_baml_stop_action_fields_match_domain_type() -> None:
    ...
    as the hand-written screen.loop.actions.StopAction. Any divergence
    ...
    assert baml_fields == _STOP_ACTION_FIELDS, (
        ...
        "Re-run `baml-cli generate` or update loop.baml to match."
    )
